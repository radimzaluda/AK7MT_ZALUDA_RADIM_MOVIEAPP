...
import com.example.ak7mt_zaluda_radim_movieapp.movieList.util.Category
import com.example.ak7mt_zaluda_radim_movieapp.movieList.views.components.MovieItem
        ...
        LazyVerticalGrid(
            ...
            items(movieListState.popularMovieList.size) { index ->
                ...
                if (index >= movieListState.popularMovieList.size - 1 && !movieListState.isLoading) {
                    onEvent(MovieListUiEvent.Paging(Category.POPULAR))
                }
